// TestDllThread.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
#include <Windows.h>
#include <strsafe.h>
#include <iostream>
...
#define DLL_NAME "C:\\Users\\Иванова\\source\\repos\\Dll1\\x64\\Release\\Dll1.dll"
...
int main()
{
    bool res = InjectRemoteThread(6300);
